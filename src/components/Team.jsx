    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mt-20 sm:mt-24">
                ...
                <h4
                    className="text-[rgba(0,9,74)] text-3xl sm:text-4xl md:text-5xl font-black tracking-wide mb-4 text-center sm:text-left"
                    data-aos="fade-up"
                    data-aos-delay="400"
                >
                    BIZNING JAMOA
                ...
                <p
                    className="text-[rgba(0,9,74,0.7)] text-sm sm:text-lg md:text-xl font-bold mb-3 tracking-wide text-center sm:text-left"
                    data-aos="fade-up"
                    data-aos-delay="500"
                >
      ...
      "
                    >
                        {team.map((member, index) => (
                            <li
                                ...
                                data-aos="fade-up"
                                data-aos-delay="300"
                                className="bg-white rounded-3xl w-75 pt-36 pb-8 text-center relative
            ...
            transition duration-300 group-hover:-translate-y-3">
                ...
                transition duration-300 group-hover:scale-105"
                                ...
                                <h5 className="font-bold text-2xl sm:text-3xl -mt-8 mb-3 text-[rgb(0,9,74)] tracking-wider">
                                    {member.name}
                                </h5>

                                <p className="text-gray-500 mb-6 tracking-wide text-lg sm:text-xl">
                                    {member.role}
                                </p>
                                ...
                                {/* Social icons */}
                                <div className="flex justify-center gap-4 sm:gap-5 text-xl">
